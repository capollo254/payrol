...
from .views import EmployeeViewSet, JobInformationViewSet, VoluntaryDeductionViewSet, EmployeeBenefitViewSet
...
router.register(r'benefits', EmployeeBenefitViewSet, basename='employee-benefit')
